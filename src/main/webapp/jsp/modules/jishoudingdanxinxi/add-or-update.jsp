		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑急售订单信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑急售订单信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">急售订单信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>物品类型</label>
										<input name="wupinleixing" id="wupinleixing" name="wupinleixing" class="form-control" placeholder="物品类型">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jishoudingdanxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jishoudingdanxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jishoudingdanxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.wupinleixing != null && res.data.wupinleixing != ''){
						...
						$("#wupinleixing").attr('readonly','readonly');
					}
