		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑学生二手</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>学生二手管理</span></li>
								<li class="breadcrumb-item active"><span>编辑学生二手</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学生二手信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>入学年份</label>
										<input name="ruxuenianfen" id="ruxuenianfen" name="ruxuenianfen" class="form-control" placeholder="入学年份">
									</div>
									<div class="form-group col-md-6">
										<label>照片</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xueshengershou/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("xueshengershou/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("xueshengershou/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xueshengershou/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("xueshengershou"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#ruxuenianfen").val(ruleForm.ruxuenianfen);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.ruxuenianfen != null && res.data.ruxuenianfen != ''){

						$("#ruxuenianfen").val(res.data.ruxuenianfen);
						$("#ruxuenianfen").attr('readonly','readonly');
					}
