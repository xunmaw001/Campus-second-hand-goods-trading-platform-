...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20220323/da7a8ec6872742db9e0253917019da43.webp) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">学生帐号</label> 
							<input  name="xueshengzhanghao" placeholder="学生帐号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="suozaixuexiao" placeholder="所在学校" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">入学年份</label> 
							<input  name="ruxuenianfen" placeholder="入学年份" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "xueshengershou/register";
				$.ajax({ 
					type: "POST",
					url: url,
